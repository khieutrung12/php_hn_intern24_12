        ...
        <div id="app">
            ...
            <header class="py-6 shadow-sm bg-pink-100 lg:bg-white">
                <div class="container flex items-center space-x-32 m-auto">
                    ...
                    <!-- logo -->
                    <a href="{{ route('home') }}" class="text-lg font-bold text-teal-800 no-underline">
                        TECHNOLOGY WORLD
                    </a>
                    <!-- logo end -->
                    ...
                    @if (Auth::check() && Auth::user()->role_id == config('auth.roles.user'))
                        ...
                        <div class="space-x-10 flex items-center justify-center">
                            ...
                            <a href="#"
                                ...
                                @else
                                    <span
                                        class="absolute left-4 bottom-7 w-5 h-5 rounded-full flex items-center justify-center bg-indigo-900 text-white text-xs">
                                        3
                                    </span>
                                @endif
                                <div class="text-2xl">
                            ...
                            <a href="{{ route('profile.edit', Auth::user()->id) }}" class="block text-center text-gray-700 hover:text-indigo-900 transition">
                                <div class="text-2xl">
                    ...
                    @elseif (Auth::check() && Auth::user()->role_id == config('auth.roles.admin'))
                        <div class="space-x-10 flex items-center justify-center">
                            <a href="{{ route('admin') }}" class="block text-center text-gray-700 hover:text-indigo-900 transition">
                                <div class="text-2xl">
                                    <i class="far fa-user"></i>
                                </div>
                                <small class="text-xs leading-3">
            ...
            <nav class="bg-gray-800 hidden lg:block">
                <div class="container m-auto">
                    <div class="flex">
                        <!-- all category -->
                        <div class="bg-indigo-900 flex items-center relative" id="button-dropdown">
                            <button
                                class="cursor-pointer text-white w-full px-12 py-4"
                                type="button">
                                <i class="fas fa-bars"></i>
                                <span class="capitalize ml-2">{{ __('titles.All categories') }}</span>
                            </button>
                            ...
                            <div
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    <div class="dropdown-1-{{ $i }}">
                                            <a href="#" class="relative px-6 py-3 flex items-center hover:bg-gray-100 hover:text-indigo-900 transition text-sm">
                                                {{ $category->name }}
                                            </a>
                                        @if ($category->childCategories->toArray())
                                            <div class="dropdown-1-sub-{{ $i }} absolute left-full w-full top-{{ $sub_1 }} bg-white shadow-md transition z-50 divide-y divide-gray-300 divide-dashed">
                                                @php
                                                    $sub_2 = 0;
                                                @endphp
                                                @foreach ($category->childCategories as $sub_category)
                                                    <div class="dropdown-2-{{ $i }}">
                                                        <a href="#" class="px-6 py-3 flex items-center hover:bg-gray-100 hover:text-indigo-900 transition text-sm">
                                                            {{ $sub_category->name }}
                                                        </a>
                                                        @if ($sub_category->childCategories->toArray())
                                                            <div class="dropdown-2-sub-{{ $i }} absolute left-full w-full top-{{ $sub_2 }} bg-white shadow-md transition z-50 divide-y divide-gray-300 divide-dashed">                                                
                                                                @foreach ($sub_category->childCategories as $sub)
                                                                <a href="#" class="dropdown-sub-3 px-6 py-3 flex items-center hover:bg-gray-100 hover:text-indigo-900 transition text-sm">
                                                                    {{ $sub->name }}
                                                                </a>
                                                                @endforeach
                                                            </div>
                        ...
                        <div class="flex items-center justify-between flex-grow pl-12">
                            <div class="flex items-center space-x-6 text-base capitalize">
                                ...
                                <a href="{{ route('shop') }}" class="text-gray-200 hover:text-white transition">
                                    {{ __('titles.Shop') }}
                                </a>
            ...
            <div
                ...
                <a href="javascript:void(0)" class="block text-center text-gray-700 hover:text-indigo-900 transition relative">
                    <div class="text-2xl" id="menuBar">
                        <i class="fas fa-bars"></i>
                    </div>
                    <div class="text-xs leading-3">{{ __('titles.Menu') }}</div>
                </a>
                <a href="#" class="block text-center text-gray-700 hover:text-indigo-900 transition relative">
                    <div class="text-2xl">
                ...
                <a href="#" class="text-center text-gray-700 hover:text-indigo-900 transition relative">
                    @if (App::getLocale() == 'en')
                        <span
                            ...
                            <div class="md:grid md:grid-cols-2 md:gap-8">
                                <div>
                                    ...
                                    <div class="mt-4 space-y-4">
                                        <a href="#" class="text-lg text-gray-500 hover:text-gray-900 block">
                                            {{ __('titles.Marketing') }}
                                        </a>
                                        <a href="#" class="text-lg text-gray-500 hover:text-gray-900 block">
                                            {{ __('titles.Analytics') }}
            ...
            <div class="bg-gray-800 py-4 m-auto">
                <div class="container flex items-center justify-between m-auto">
                    <p class="text-white">© TECHNOLOGY WORLD - All Rights Reserved</p>
                    <div>
